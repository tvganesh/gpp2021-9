...
# Analyze IPL batsmen
analyzeBatsmen <- function(batsman,func, t20type="IPL",dateRange, staticIntv=1) {
    print("*************In analyze batsman********************************************************************************")
    cat("AB",dateRange[1],dateRange[2])
    ...
    if(func == "Batsman Runs vs. Deliveries"){
        batsmanRunsVsDeliveries(batsmanDF,batsman,dateRange, staticIntv)
    } else if (func == "Batsman 4s & 6s"){
        batsmanFoursSixes(batsmanDF,batsman,dateRange,staticIntv)
    } else if (func == "Predict runs of batsman"){
        batsmanRunsPredict(batsmanDF,batsman,dateRange)
    }     else if (func == "Dismissals of batsman"){
        batsmanDismissals(batsmanDF,batsman,dateRange)
    } else if (func == "Batsman's Runs vs Strike Rate"){
        batsmanRunsVsStrikeRate(batsmanDF,batsman,dateRange,staticIntv)
    } else if (func == "Batsman's Moving Average"){
        batsmanMovingAverage(batsmanDF,batsman,dateRange,staticIntv)
    } else if (func == "Batsman's Cumulative Average Runs"){
        batsmanCumulativeAverageRuns(batsmanDF,batsman,dateRange,staticIntv)
    } else if (func == "Batsman's Cumulative Strike Rate"){
        batsmanCumulativeStrikeRate(batsmanDF,batsman,dateRange,staticIntv)
    } else if (func == "Batsman's Runs against Opposition"){
        batsmanRunsAgainstOpposition(batsmanDF,batsman,dateRange,staticIntv)
    } else if (func == "Batsman's  Runs at Venue"){
        batsmanRunsVenue(batsmanDF,batsman,dateRange,staticIntv)
    } else if (func == "Predict Runs of batsman"){
        batsmanRunsPredict(batsmanDF,batsman,dateRange)
    }
